        ...
        <div className='bgColor'>
          ...
          >
            <div className='flex flex-row'>
              <Link to='/'>
                <button className='border border-violet-700 bg-violet-700 text-white rounded-md px-4 py-2 transition duration-500 ease select-none hover:bg-violet-900 focus:outline-none focus:shadow-outline'>
                  <svg
              ...
              <div className='flex justify-center w-11/12'>
                <div className='flex flex-col'>
                  <p className='text-violet-700 text-3xl p-1 font-semibold'></p>
